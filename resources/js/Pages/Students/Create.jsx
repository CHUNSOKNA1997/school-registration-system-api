...
export default function CreateStudent({ classrooms }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post('/students', {
            onSuccess: () => toast.success('Student created successfully'),
    ...
    return (
        <AuthenticatedLayout>
            ...
            <PageHeader icon={Users} title="Add Student" description="Create a new student record">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    <Button type="button" variant="outline" onClick={() => router.get('/students')}>
                        Cancel
                    </Button>
