...
export default function EditClass({ classroom }) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <Card>
                    ...
                    <CardContent className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <FIELD label="Class Name" required error={errors.name}><Input value={data.name} onChange={(e) => setData('name', e.target.value)} /></FIELD>
                        ...
                        <FIELD label="Section" required error={errors.section}><Input value={data.section} onChange={(e) => setData('section', e.target.value)} /></FIELD>
                ...
                <div className="flex items-center justify-end gap-3">
                    <Button type="button" variant="outline" onClick={() => router.get(`/classes/${classroom.id}`)}>Cancel</Button>
